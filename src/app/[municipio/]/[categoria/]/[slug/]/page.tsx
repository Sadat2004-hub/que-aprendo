...
export default async function CourseDetailPage({ params }: Props) {
    ...
    const PriceCard = ({ isMobile = false }) => (
        <div style={isMobile ? styles.priceCardMobile : styles.priceCard}>
        ...
        <div style={styles.container}>
            ...
            <div className="container">
                ...
                <div className="detail-grid">
                    ...
                    <aside className="hide-mobile" style={styles.sidebar}>
                        <PriceCard />
                    ...
                    {/* Related section for mobile (since sidebar is hidden) */}
                    <div className="show-mobile" style={styles.relatedMobile}>
                        <h2 style={styles.sectionTitle}>Cursos similares</h2>
